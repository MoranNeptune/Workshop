...
class TestStore(unittest.TestCase):
    ...
    def test_add_condition_discount_to_product(self):

        self.assertTrue(self.store.add_conditional_discount_to_product("Banana", "test owner", self.new_discount))
        self.assertTrue(self.store.add_conditional_discount_to_product("Banana", "test owner", self.new_discount))
        self.assertFalse(self.store.add_conditional_discount_to_product("Banana", "Lielle", self.new_discount))
        self.assertFalse(self.store.add_conditional_discount_to_product("Banana", "Noa", self.new_discount))
        self.assertFalse(self.store.add_conditional_discount_to_product("not real product", "test owner", self.new_discount))
